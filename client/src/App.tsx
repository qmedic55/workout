...
function LandingPage() {
  ...
  const { hasGoogle, hasFacebook, hasTwitter, isLoading: providersLoading } = useOAuthProviders();
            ...
            <div className="flex flex-col items-center gap-3 mt-6">
              ...
              {hasGoogle && (
                <Button
                  ...
                  asChild
                  variant="outline"
                  className="w-full max-w-xs border-2"
              ...
              {hasFacebook && (
                <Button
                  size="lg"
                  asChild
                  className="bg-[#1877F2] hover:bg-[#166FE5] text-white w-full max-w-xs"
